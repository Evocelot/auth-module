...
Authentication and authorization module application based on Jakarta and Wildfly technology,
which can be könnyen integrálható HTTP kommunikációra képes alkalmazásokkal.

A modul célja általános authentikációs és authorizációs megoldást nyújtani.
